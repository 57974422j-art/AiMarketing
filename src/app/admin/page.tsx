...
const sections: CardSection[] = [
  {
    ...
    items: [
      ...
      { title: '任务中心', desc: '创建和监控自动化任务执行', href: '/admin/automation', icon: '⚡', roles: ['admin', 'editor'] },
  ...
  },
  {
    ...
    items: [
      ...
      { title: '任务模板', desc: '预设自动化任务模板', href: '/admin/automation-templates', icon: '📋', roles: ['admin', 'editor'] },
  ...
  },
  {
    ...
    items: [
      ...
      { title: '邀请码管理', desc: '生成和管理注册邀请码', href: '/admin/invite-codes', icon: '🔑', roles: ['admin'] },
