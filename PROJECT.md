...
| 二期 B | create_ai_video 一句话成片 ✅；**/ai-video-tasks 分镜节点链页 ✅**；**提示词库 ✅**：独立页 /admin/prompt-sources（canvas.best 风格：内置 6 源/条数/状态/开关/间隔/单源刷新/自定义源/定时拉取服务端 5 分钟检查）+ PromptSource 表 + 标签筛选/封面/作者（本地验证 6 源 1201 条入库）；prompt-templates 同步区块已移除收口新页 |
